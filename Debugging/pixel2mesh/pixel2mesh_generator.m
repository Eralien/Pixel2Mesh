...
if 1
    root = '/media/eralien/ReservoirLakeBed/Pixel2Mesh/TuSimple/train_set/';
    folder = {'/media/eralien/ReservoirLakeBed/Pixel2Mesh/TuSimple/train_set/label_data_0313.json';
        '/media/eralien/ReservoirLakeBed/Pixel2Mesh/TuSimple/train_set/label_data_0531.json';
        '/media/eralien/ReservoirLakeBed/Pixel2Mesh/TuSimple/train_set/label_data_0601.json'};
else
    root = '/media/eralien/ReservoirLakeBed/Pixel2Mesh/TuSimple/test_set/';
    folder = {'/media/eralien/ReservoirLakeBed/Pixel2Mesh/TuSimple/test_set/test_baseline.json'};
end
save = 0;
load('pkl.mat');
